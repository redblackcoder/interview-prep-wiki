...
## Connections
- [[system-design-concepts/timeline-fanout-hybrid]] — the **third** fan-out shape: precompute-vs-compute for a *stored* feed. This page is *live* one→many (a ticking value); that one is *stored* feed assembly. Disambiguate the three.
